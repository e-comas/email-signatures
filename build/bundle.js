...
var app = (function () {
    ...
    */
    function stringify(input) {
        try {
            wasm.stringify(8, addBorrowedObject(input));
    ...
    var tomlParserUrl = "build/71cc98231cca1a1b.wasm";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "autocomplete", /*autocomplete*/ ctx[3]);
    			add_location(input, file$2, 10, 2, 175);
    			add_location(label_1, file$2, 8, 0, 155);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let { value = "" } = $$props;
    	let { autocomplete = "auto" } = $$props;
    	let { type = "text" } = $$props;
    	const writable_props = ["name", "label", "value", "autocomplete", "type"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("autocomplete" in $$props) $$invalidate(3, autocomplete = $$props.autocomplete);
    		if ("type" in $$props) $$invalidate(4, type = $$props.type);
    	};

    	$$self.$capture_state = () => ({ name, label, value, autocomplete, type });
    	...
    	return [name, label, value, autocomplete, type];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(legend, file$1, 7, 4, 180);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$1, 14, 4, 578);
    			add_location(fieldset, file$1, 6, 2, 165);
    			add_location(form, file$1, 5, 0, 156);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(input0, fieldset, null);
    			append_dev(fieldset, t2);
    			mount_component(input1, fieldset, null);
    			append_dev(fieldset, t3);
    			mount_component(input2, fieldset, null);
    			append_dev(fieldset, t4);
    			mount_component(input3, fieldset, null);
    			append_dev(fieldset, t5);
    			mount_component(input4, fieldset, null);
    			append_dev(fieldset, t6);
    			mount_component(input5, fieldset, null);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { user } = $$props;
    	const { Name, Title, Phone, url: { Medium, LinkedIn, YouTube } } = user;
    	...
    	return [Name, Title, Phone, Medium, LinkedIn, YouTube, user];
    }

    class Form extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$1, create_fragment$1, safe_not_equal, { user: 6 });
    		...
    		if (/*user*/ ctx[6] === undefined && !("user" in props)) {
    			console.warn("<Form> was created without expected prop 'user'");
    		}
    	}
    ...
    function create_then_block(ctx) {
    	...
    	form = new Form({
    			props: {
    				user: /*users*/ ctx[1][/*state*/ ctx[0].mail]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const form_changes = {};
    			if (dirty & /*state*/ 1) form_changes.user = /*users*/ ctx[1][/*state*/ ctx[0].mail];
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(15:16)      <p>...loading</p>   {:then users}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 13, 2, 440);
    			attr_dev(main, "class", "svelte-1e9puaw");
    			add_location(main, file, 12, 0, 431);
    		},
    		l: function claim(nodes) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const users = Promise.all([
    		init(tomlParserUrl),
    		fetch("data.toml").then(response => response.ok
    		? response.arrayBuffer()
    		: Promise.reject(new Error(response.statusText)))
    	]).then(([_, data]) => parse(new Uint8Array(data)));
    	...
    	$$self.$capture_state = () => ({ TOML, tomlParserUrl, Form, state, users });
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance, create_fragment, safe_not_equal, { state: 0 });
    ...
    const app = new App({
        ...
        props: {
            state: { mail: "a.lopez@e-comas.com" },
        },
    });
